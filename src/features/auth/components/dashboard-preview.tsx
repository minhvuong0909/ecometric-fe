    ...
    >
      <div className="mb-8 flex items-start justify-between gap-4">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-semibold text-foreground">ESG Overview</h3>
        </div>
      ...
      <div className="rounded-xl border border-border bg-muted p-6">
        ...
        <div
          ...
          role="img"
          aria-label="Bar chart showing improving monthly emissions trend"
        >
